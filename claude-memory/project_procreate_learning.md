...
- 2026-09-17：確認筆與題材方向後，全面改寫壓感相關練習、加入人物支線、重排 12 週後路線圖；線上練習台同步更新。
- **2026-09-25：起算日定案 —— 09-25 為設定日，`2026-09-26（六）= W1 D1`，每週從星期六算起、星期五休息。** 12 週結束於 2026-12-18。練習台的 `START` 與 `progress-log.md` 的追蹤表都已改；練習台加了 `START_V` 版本號，之後再改起算日要 +1 才能蓋掉裝置上存的舊值。
